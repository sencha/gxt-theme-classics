...
/**
 * <p>{@link Frame} and {@link CollapsibleFrame} implementation that creates its frame using 3 sets of 3 nested DIVs. See
 * NestedDivFrame.html and NestedDivFrame.gss. This implementation uses images to render rounded corners.</p>
 * <p><code>NestedDivFrameResources</code> MUST be extended / implemented to provide the images for this frame.</p>
 */
