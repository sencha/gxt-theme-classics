...
/**
 * <p><code>Frame</code> implementation that renders its frame using 9 absolutely
 * positioned DIVs.</p>
 * <p>See <a href='http://code.google.com/p/google-web-toolkit/wiki/CssResourceCookbook'>
 * CssResourceCookbook</a> for more information.</p>
 */
